...
###### csvファイルの注意事項
csvファイルで必要な情報は「店舗マネージャーのID」「エリア」「ジャンル」「店舗名」「店舗概要」「画像URL」の6つです  

###### 例）
![alt text](<スクリーンショット 2024-09-27 4.05.18.png>)
...
- 画像URL：.jpegファイルか、.pngファイルのみアップロード可能です。末尾が.jpegもしくは.png以外であればインポートできません  
